	...
	ref.orderByChild('id').equalTo(key).on("value", function(snapshot) {
		...
		snapshot.forEach(function(data) {
			...
			.then(function(snapshot){
				...
				document.getElementById("description_txt1").value = description1;
				var description2 = snapshot.child(id).child("description2").val();
				document.getElementById("description_txt2").value = description2;
				...
				document.getElementById("inpuInDate").value = date_in2;
...
function submitOnClick(){
	...
	var description1 = document.getElementById('description_txt1').value;
	var description2 = document.getElementById('description_txt2').value;


	var date_in = document.getElementById('inpuInDate').value;
